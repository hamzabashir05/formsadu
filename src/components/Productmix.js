...
export default class Productmix extends Component {
  render() {
    return (
       < Container fluid>
           <div className='d-flex mb-3 mt-3 buttons_menu_display'> 
                    <div className='p-2 flex-grow-1 ds_size '> <h4>Product Mix </h4></div>
            ...
            <Card>
                ...
                <Table bordered responsive className='mt-3 align-middle item_code_table' >
                        ...
                        <thead  >
                            <tr >
                                <td colSpan={29} className='data_display_table1'> Printing & Stationary </td>
                            </tr>
                        </thead>
